...
const generatePlayers = (teamPrefix: string): any[] => {
  return Array.from({ length: 11 }, (_, i) => ({
    ...
    position: i === 0 ? "GK" : "P",
    image: `https://picsum.photos/seed/${teamPrefix}${i}/200/200`
  }));
};
...
export const TEAMS_DB: Record<string, Team> = {
  REAL_MADRID: {
    ...
    players: [
      ...
      { id: 'rma-2', number: 2, name: 'Carvajal', position: 'DEF' },
      { id: 'rma-3', number: 3, name: 'Militão', position: 'DEF' },
      { id: 'rma-4', number: 22, name: 'Rüdiger', position: 'DEF' },
      { id: 'rma-5', number: 23, name: 'Mendy', position: 'DEF' },
      { id: 'rma-6', number: 8, name: 'Valverde', position: 'MID' },
      { id: 'rma-7', number: 14, name: 'Tchouaméni', position: 'MID' },
      { id: 'rma-8', number: 5, name: 'Bellingham', position: 'MID' },
      { id: 'rma-9', number: 11, name: 'Rodrygo', position: 'FWD' },
      { id: 'rma-10', number: 7, name: 'Vinícius Jr.', position: 'FWD' },
      { id: 'rma-11', number: 9, name: 'Mbappé', position: 'FWD' },
    ],
  ...
  BARCELONA: {
    ...
    coach: 'Hansi Flick',
    players: [
      { id: 'bar-1', number: 1, name: 'Ter Stegen', position: 'GK' },
      { id: 'bar-2', number: 23, name: 'Koundé', position: 'DEF' },
      { id: 'bar-3', number: 2, name: 'Cubarsí', position: 'DEF' },
      { id: 'bar-4', number: 4, name: 'Araújo', position: 'DEF' },
      { id: 'bar-5', number: 3, name: 'Balde', position: 'DEF' },
      { id: 'bar-6', number: 8, name: 'Pedri', position: 'MID' },
      { id: 'bar-7', number: 6, name: 'Gavi', position: 'MID' },
      { id: 'bar-8', number: 21, name: 'De Jong', position: 'MID' },
      { id: 'bar-9', number: 19, name: 'Lamine Yamal', position: 'FWD' },
      { id: 'bar-10', number: 11, name: 'Raphinha', position: 'FWD' },
      { id: 'bar-11', number: 9, name: 'Lewandowski', position: 'FWD' },
    ],
